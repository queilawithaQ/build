...
require (
	...
	dmitri.shuralyov.com/service/change v0.0.0-20190301072032-c25fb47d71b3
	...
	github.com/shurcooL/issues v0.0.0-20190120000219-08d8dadf8acb
	github.com/shurcooL/issuesapp v0.0.0-20181229001453-b8198a402c58
